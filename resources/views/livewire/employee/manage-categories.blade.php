<div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="modal-content">
                ...
                <form>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary" wire:click.prevent="submitForm('add')"
    ...
    <div wire:ignore.self class="modal fade" id="deleteAllModal" tabindex="-1" aria-labelledby="deleteAllModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
            ...
            <div class="row">
                <div class="col">
                    <button type="button" class="btn btn-danger my-3 py-3 w-100" data-bs-toggle="modal"
                        data-bs-target="#deleteAllModal" @if ($child_checkboxes_checked === false) disabled @endif
                        title="Delete All">
                    ...
                    <tr>
                        <td>
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input form-checkbox-custom"
                                    id="headingCheckBox" wire:click="$toggle('child_checkboxes_checked')">
                            </div>
                        </td>
                ...
                <tbody class="table-border-bottom-0">
                    ...
                    @forelse ($data as $single_index)
                        <tr>
                            <td>
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input form-checkbox-custom" value="{{ $single_index->id }}"
                                        wire:model="child_checkboxes_checked" wire:click="selectAllCheckboxes">
                                </div>
                            </td>
                            <td>{{ $single_index->id }}</td>
                            <td>
                                <a href="{{ route('emp.exercises.active', ['cat_id' => $single_index->id]) }}">
                                    {{ $single_index->name }}
                                </a>
                                <div>
                                    Total:
                                    <span class="ms-3">
                                        Exercises: {{ $this->totalExercisesOfCategory($single_index->id) }}
                                    </span>
                                    <span class="ms-3">
                                        Beginner: {{ $this->totalExercisesOfCategoryLevel($single_index->id, 1) }}
                                    </span>
                                    <span class="ms-3">
                                        Intermediate: {{ $this->totalExercisesOfCategoryLevel($single_index->id, 2) }}
                                    </span>
                                    <span class="ms-3">
                                        Expert: {{ $this->totalExercisesOfCategoryLevel($single_index->id, 3) }}
                                    </span>
                                    <span class="ms-3">
                                        Sub Categories: {{ $this->totalSubCategoriesOfCategory($single_index->id) }}
                                    </span>
                                </div>
                            </td>
                            <td>
                                    ...
                                    <div class="accordion-item accordion-item-custom">
                                        <h2 class="accordion-header text-end" id="flush-heading{{ $i }}">
                                            <button
                                                ...
                                                data-bs-target="#subCategory{{ $i }}"
                                                aria-expanded="false" aria-controls="subCategory{{ $i }}">
                                                Sub Categories
                                            </button>
                                        </h2>
                                        <div id="subCategory{{ $i }}" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body sub-category-bg">
                                                <livewire:employee.manage-sub-categories :parent_category_id="$single_index->id"
