<div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="addModalLabel">Add Focused Area</h5>
                ...
                <form>
                    <div class="modal-body">
                        <div class="row">
                            <div class="col mb-3">
                                <label class="form-label">Focused Area</label>
                                <input type="text" placeholder="Enter focused area name" wire:model.lazy="focused_area" class="form-control">
    ...
    <div wire:ignore.self class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="editModalLabel">Edit Focused Area</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" wire:click="resetModal"></button>
                </div>
                <form>
                    <div class="modal-body">
                        <div class="row">
                            <div class="col mb-3">
                                <label class="form-label">Focused Area</label>
                                <input type="text" placeholder="Enter focused area name" value="{{ $focused_area }}" wire:model.lazy="focused_area" class="form-control">
                                <small class="text-danger">
                                    @error('focused_area')
                                        {{ $message }}
                                    @enderror
    ...
    <div class="row">
        <div class="col-12 col-sm-6 col-md-6">
            <h1 class="py-3 my-1">{{ config('app.name') }} Focused Area</h1>
        </div>
        ...
        <div class="col-12 col-md-1">
            <button type="button" class="btn btn-primary my-3 py-3 w-100" data-bs-toggle="modal" data-bs-target="#addModal" title="Add Focused Area">
            ...
            <table class="table table-hover">
                <thead>
                    <tr>
                        ...
                        <th class="col-md-9">Focused Area</th>
